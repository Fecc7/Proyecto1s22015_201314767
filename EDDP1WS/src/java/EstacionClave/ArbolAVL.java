...
public final class ArbolAVL {
    ...
    Nodo raiz=null;
    public ArbolAVL(){
    //Agregar(new EstacionClave("b","b"));
    //Agregar(new EstacionClave("za","za"));
    //Agregar(new EstacionClave("c","za"));
    ...
    Agregar(new EstacionClave(0,"Estacion 1","123456"));    
    Agregar(new EstacionClave(1,"Estacion 1","123456"));    
    Agregar(new EstacionClave(2,"Estacion 1","123456"));    
    Agregar(new EstacionClave(3,"Estacion 1","123456"));    
    Agregar(new EstacionClave(4,"Estacion 1","123456"));    
    Agregar(new EstacionClave(5,"Estacion 1","123456"));    
    Agregar(new EstacionClave(6,"Estacion 1","123456"));    
    Agregar(new EstacionClave(7,"Estacion 1","123456"));    
    Agregar(new EstacionClave(8,"Estacion 1","123456"));    
...
public Nodo EquilibrarTrasEliminar(Nodo raiz,int id){
    ...
    try {
        ...
        codigo+="\n}";
        String ruta = "C:\\Users\\Francis\\Desktop\\ArbolEstacionClave.txt";
      ...
      String fileInputPath = "C:\\Users\\Francis\\Desktop\\ArbolEstacionClave.txt";
      String fileOutputPath = "C:\\Users\\Francis\\Desktop\\ArbolEstacionClave.jpg";
