 ...
 */
public class Nodo {
    EstacionGeneral estaciongeneral;
    Nodo hijoIzq=null,hijoDer=null;
    int alturaizq=0,alturader=0,fe=0;
    public Nodo(EstacionGeneral nuevo){
    estaciongeneral=nuevo;
    }

    public EstacionGeneral getEstacionGeneral() {
        return estaciongeneral;
    }

    public void setEstacionGeneral(EstacionGeneral estaciongeneral) {
        this.estaciongeneral = estaciongeneral;
    }
    ...
    public static int Altura(Nodo raiz){
        ...
        System.out.println(raiz.getEstacionGeneral().getId()+" "+raiz.getFe());
        return a;
        }
