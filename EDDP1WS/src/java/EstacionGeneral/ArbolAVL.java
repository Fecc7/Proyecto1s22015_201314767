...
public final class ArbolAVL {
    ...
    Nodo raiz=null;
    public ArbolAVL(){
    //Agregar(new EstacionGeneral("b","b"));
    //Agregar(new EstacionGeneral("za","za"));
    //Agregar(new EstacionGeneral("c","za"));
    ...
    Agregar(new EstacionGeneral(0,"Estacion 1","123456"));    
    Agregar(new EstacionGeneral(1,"Estacion 1","123456"));    
    Agregar(new EstacionGeneral(2,"Estacion 1","123456"));    
    Agregar(new EstacionGeneral(3,"Estacion 1","123456"));    
    Agregar(new EstacionGeneral(4,"Estacion 1","123456"));    
    Agregar(new EstacionGeneral(5,"Estacion 1","123456"));    
    Agregar(new EstacionGeneral(6,"Estacion 1","123456"));    
    Agregar(new EstacionGeneral(7,"Estacion 1","123456"));    
    Agregar(new EstacionGeneral(8,"Estacion 1","123456"));    
    Agregar(new EstacionGeneral(9,"Estacion 1","123456"));    
...
public Nodo EquilibrarTrasEliminar(Nodo raiz,int id){
    ...
    if(Padre==null){
    salida+="nodo"+(na)+" [ label =\""+actual.getEstacionGeneral().getId()+"\"];\n";
    numero++;
    }else{
    ...
    try {
        ...
        codigo+="\n}";
        String ruta = "C:\\Users\\Francis\\Desktop\\ArbolEstacionGeneral.txt";
      ...
      String fileInputPath = "C:\\Users\\Francis\\Desktop\\ArbolEstacionGeneral.txt";
      String fileOutputPath = "C:\\Users\\Francis\\Desktop\\ArbolEstacionGeneral.jpg";
