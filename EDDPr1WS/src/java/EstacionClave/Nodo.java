...
public class Nodo {
    EstacionClave estacionclave;
    Nodo hijoIzq=null,hijoDer=null;
    int alturaizq=0,alturader=0,fe=0;
    public Nodo(EstacionClave nuevo){
    estacionclave=nuevo;
    }

    public EstacionClave getEstacionClave() {
        return estacionclave;
    }

    public void setEstacionClave(EstacionClave estacionclave) {
        this.estacionclave = estacionclave;
    }
    ...
    public static int Altura(Nodo raiz){
        ...
        System.out.println(raiz.getEstacionClave().getId()+" "+raiz.getFe());
        return a;
        }
